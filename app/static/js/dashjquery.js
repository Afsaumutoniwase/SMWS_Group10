...
!function() {
    ...
    Calendar.prototype.renderEvents = function(events, ele) {
      ...
      if(!events.length) {
        ...
        var span = createElement('span', '', 'No pickups');
  ...
  !function() {
    var data = [
      { eventName: 'General Waste Pickup', calendar: 'Waste', color: 'orange', start: '2024-06-15' },
      { eventName: 'Recyclables Pickup', calendar: 'Waste', color: 'blue', start: '2024-06-18' },
      { eventName: 'Organic Waste Pickup', calendar: 'Waste', color: 'green', start: '2024-06-22' },
      { eventName: 'General Waste Pickup', calendar: 'Waste', color: 'orange', start: '2024-06-29' },
      { eventName: 'Recyclables Pickup', calendar: 'Waste', color: 'blue', start: '2024-07-02' },
      { eventName: 'Organic Waste Pickup', calendar: 'Waste', color: 'green', start: '2024-07-06' }
  ];
